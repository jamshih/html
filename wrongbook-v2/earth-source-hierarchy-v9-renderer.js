...
(function(){
  ...
  const TEMP=`<svg class="v9-p252-temp-figure" data-source-role="graph" data-graph-kind="temperature-depth" viewBox="0 0 185 150" aria-label="海水溫度垂直分層"><path d="M28 18H160M28 18V140" stroke="#555" stroke-width="1.5"/><path d="M126 24C108 34 78 39 59 49C48 59 42 75 40 94C38 111 38 128 38 139" fill="none" stroke="#bd5450" stroke-width="3"/><path d="M28 58H58M154 58H172M28 103H52M170 103H172" stroke="#8ba0af" stroke-width="1" stroke-dasharray="4 4"/><text x="82" y="12" font-size="9">溫度（°C）</text><text x="9" y="90" font-size="9" transform="rotate(-90 9 90)">深度（公里）</text></svg>`;
