...
const initial={page:'home',subject:'biology',selectedProblemId:'bio-1',problems:SEED_PROBLEMS,syllabus:defaultSyllabus,scan:null,scanStudent:[],scanCorrect:[],scanConfirmed:false,scanImage:'',scanBase64:'',scanMime:'image/jpeg',aiLoading:false,aiError:'',tutor:null,annotations:[],reviewMode:'problem',reviewSelections:[],reviewChecked:false,mindAnswers:{},mindHints:{},mindChapter:{},mindFilter:'all',mindRevealed:{},notes:[],community:[],communityLoading:false,mobileMenu:false,ink:{},aiOnline:null,search:''};
let loaded={};try{loaded=JSON.parse(storageGet('wrongbook-v2-state')||'{}')}catch{}
let state={...initial,...loaded,syllabus:{...defaultSyllabus,...(loaded.syllabus||{}),publishers:{...defaultSyllabus.publishers,...(loaded.syllabus?.publishers||{})}},problems:Array.isArray(loaded.problems)&&loaded.problems.length?loaded.problems:SEED_PROBLEMS,mindChapter:{...(loaded.mindChapter||{})},mindRevealed:{...(loaded.mindRevealed||{})},page:'home',mobileMenu:false,aiLoading:false,aiError:''};

const NAV=[['home','今天','home'],['notebook','我的錯題','notebook'],['concepts','各科概念','brain'],['mindmap','心智圖','map'],['review','複習計畫','calendar'],['tutor','AI 家教','spark'],['community','社群討論','chat'],['notes','我的筆記','note'],['analytics','弱點分析','chart'],['settings','設定','settings']];
