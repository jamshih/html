...
let state={...initial,...loaded,syllabus:{...defaultSyllabus,...(loaded.syllabus||{}),publishers:{...defaultSyllabus.publishers,...(loaded.syllabus?.publishers||{})}},problems:Array.isArray(loaded.problems)&&loaded.problems.length?loaded.problems:SEED_PROBLEMS,mindChapter:{...(loaded.mindChapter||{})},mindRevealed:{...(loaded.mindRevealed||{})}};
