...
(function(){
  ...
  window.v5PageHtml=function(ch,sem,page,mode){
    ...
    html=html.replace(/<svg class="v6-p246-daily"[\s\S]*?<\/svg>/,DAILY).replace('class="v6-p246-lines"','class="v6-p246-lines" data-v7-line-manifest="246"');
    return html;
  };
