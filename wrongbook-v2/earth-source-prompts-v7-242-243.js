...
(function(){
 ...
 M[242]=[
  E(1,'體積極 <b class="v4strict-num">(1)</b> {{0}}',1,['小'],{sourceRect:R(79,574,127,30)}),
  E(2,'壓力極 <b class="v4strict-num">(2)</b> {{0}}',1,['大'],{sourceRect:R(79,608,127,30)}),
  E(3,'密度極 <b class="v4strict-num">(3)</b> {{0}}',1,['大'],{sourceRect:R(79,642,127,30)}),
  E(4,'時間：<b class="v4strict-num">(4)</b> {{0}}',1,['約138億年前'],{sourceRect:R(185,535,205,32)}),
  E(5,'溫度極 <b class="v4strict-num">(5)</b> {{0}}',1,['高'],{sourceRect:R(282,471,165,30)}),
  E(6,'宇宙開始 <b class="v4strict-num">(6)</b> {{0}}，溫度隨之 <b class="v4strict-num">(7)</b> {{1}}',2,['膨脹','下降'],{sourceNumbers:[6,7],sourceRect:R(60,382,320,28)}),
  ...
  E(11,'<span class="v7-p242-source-line">最初原始太陽星雲呈 <b class="v4strict-num">(11)</b> {{0}} 溫狀態，後因 {{1}} 作用，</span><span class="v7-p242-source-line">塌縮成 {{2}}（填形狀），雲氣中心溫度逐漸 {{3}}</span>',4,['低','重力','扁平圓盤','上升'],{sourceRect:R(64,718,505,58)}),
  ...
  E(14,'<span class="v7-p242-source-line"><b class="v4strict-num">(14)</b> 愈靠近太陽，環境溫度愈 {{0}}，</span><span class="v7-p242-source-line">岩石金屬可留在內側形成類 {{1}} 行星</span>',2,['高','地'],{sourceRect:R(61,1112,300,66)}),
  ...
  E(18,'<span class="v7-p242-circled-num"><b class="v4strict-num">(18)</b></span><strong>3大主因</strong><br>1. {{0}}<br>2. {{1}}<br>3. {{2}}',3,['隕石撞擊','質量增加、重力收縮','放射性元素衰變'],{sourceRect:R(430,893,190,157)}),
  E(19,'<span class="v7-p242-source-line"><b class="v4strict-num">(19)</b> 密度較 {{0}} 的</span><span class="v7-p242-source-line">{{1}}（填組成）下沉</span>',2,['大','Fe、Ni'],{sourceRect:R(627,939,223,67)}),
  E(20,'<span class="v7-p242-source-line"><b class="v4strict-num">(20)</b> 密度較 {{0}} 的</span><span class="v7-p242-source-line">{{1}}（填組成）上升</span>',2,['小','SiO₂'],{sourceRect:R(627,1007,223,67)})
 ];
 M[243]=[
