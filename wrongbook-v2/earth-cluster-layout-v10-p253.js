  ...
  function repair253(t){
    ...
    lines.innerHTML=`
      ...
      <g class="v10-p253-ocean-lines" fill="none" stroke="#5b9357" stroke-linecap="square" stroke-linejoin="miter">
        ...
        <!-- wave cluster: explanatory copy stays left; q43-q45 are an explicit right-hand subgroup. -->
        ...
        <!-- tide cluster: short source branch stubs, never through prompt prose -->
