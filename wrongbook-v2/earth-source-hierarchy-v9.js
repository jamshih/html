...
(function(){
 ...
 add(p,N('p252-enso-q19','source-box',R(0,75,85,55),{parentId:'p252-enso',containerKind:'source-box',contentRect:R(4,4,77,47)}));
 ...
 add(p,N('p252-mixed-upwelling','source-box',R(0,250,330,78),{parentId:'p252-ocean-temp',containerKind:'source-box',contentRect:R(8,6,314,68)}));
 add(p,N('p252-temp-depth','protected-figure',R(0,370,185,150),{parentId:'p252-ocean-temp',containerKind:'source-figure-with-label-anchors',anchors:{q12:R(165,24,120,32),q13:R(70,54,105,34),q14:R(60,104,120,34)}}));
 add(p,N('p252-temp-explain','source-box',R(190,415,170,115),{parentId:'p252-ocean-temp',containerKind:'source-box',contentRect:R(8,8,154,99)}));
 ...
 own(p,'p252-typhoon',[1,2,3,4,5,6,7]);own(p,'p252-horizontal',[8,9,10]);own(p,'p252-mixed-upwelling',[11,16]);own(p,'p252-temp-depth',[12,13,14]);own(p,'p252-temp-explain',[15]);own(p,'p252-enso-q17',[17]);own(p,'p252-enso-figure',[18]);own(p,'p252-enso-q19',[19]);own(p,'p252-salinity',[20,21,22,23,24,25,26]);
