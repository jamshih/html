...
(function(){
 ...
 add(p,N('p252-enso-figure','protected-figure',R(100,70,230,190),{parentId:'p252-enso',containerKind:'source-figure-with-label-anchors'}));
 ...
 add(p,N('p252-temp-depth','protected-figure',R(0,400,185,150),{parentId:'p252-ocean-temp',containerKind:'source-figure-with-label-anchors',anchors:{q12:R(165,10,120,32),q13:R(70,47,105,34),q14:R(45,101,120,34)}}));
 ...
 own(p,'p252-typhoon',[1,2,3,4,5,6,7]);own(p,'p252-horizontal',[8,9,10]);own(p,'p252-mixed-upwelling',[11,16]);own(p,'p252-temp-depth',[12,13,14]);own(p,'p252-temp-explain',[15]);own(p,'p252-enso-q17',[17]);own(p,'p252-enso',[18]);own(p,'p252-enso-q19',[19]);own(p,'p252-salinity',[20,21,22,23,24,25,26]);
