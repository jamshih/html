...
(function(){
 ...
 add(p,N('p252-ocean-temp','group',R(410,30,360,565),{parentId:'p252-ocean'}));
 ...
 add(p,N('p252-temp-depth','protected-figure',R(410,400,185,150),{parentId:'p252-ocean',containerKind:'source-figure-with-label-anchors',anchors:{q12:R(165,24,120,32),q13:R(70,54,120,34),q14:R(60,104,125,34)}}));
 add(p,N('p252-temp-explain','source-box',R(600,415,170,115),{parentId:'p252-ocean',containerKind:'source-box',contentRect:R(8,8,154,99)}));
 ...
 add(p,N('p253-greenhouse-cloud','graphic-container',R(0,110,470,100),{parentId:'p253-climate-left',containerKind:'source-cloud',contentRect:R(18,25,445,64),safeRect:R(0,0,235,100),protectedGeometry:[{kind:'outline',rect:R(0,0,235,100),inset:3}]}));
 add(p,N('p253-energy','protected-figure',R(480,0,300,365),{parentId:'p253-climate',containerKind:'source-figure-with-label-anchors',anchors:{q33:R(-170,5,230,65),q34:R(-110,300,260,55),q35:R(95,225,200,100)}}));
