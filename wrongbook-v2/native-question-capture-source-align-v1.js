...
(function(){
  ...
  loadStyle('./iscanner-capture-v2.css?wb=20260818-1108','wrongbook-iscanner-capture-v2-css');
  loadStyle('./ocr-clean-question-display-v1.css?wb=20260818-1108','wrongbook-ocr-clean-display-css');
  loadScript('./on-device-image-preprocess-v2.js?wb=20260818-1108','data-wb-preprocess-v2');
  loadScript('./iscanner-capture-v3.js?wb=20260818-1108','data-wb-iscanner-v3');
  loadScript('./iscanner-live-autocapture-v1.js?wb=20260818-1108','data-wb-iscanner-live');
  loadScript('./iscanner-highlight-bridge-v3.js?wb=20260818-1108','data-wb-ocr-first-highlight');
  loadScript('./ocr-first-analysis-v1.js?wb=20260818-1108','data-wb-ocr-first-analysis');
  loadScript('./ocr-clean-question-display-v1.js?wb=20260818-1108','data-wb-ocr-clean-display');
})();
