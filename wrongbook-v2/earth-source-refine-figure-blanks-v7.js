...
(function(){
 ...
 window.v5PageHtml=function(ch,sem,page,mode){
   ...
   if(page===248){
     ...
     const q15=`<div class="v7-p248-q15 v5-recall" data-question="15" data-page="248" data-v7-source-figure-blanks="11" data-source-container-only="true" style="position:absolute;inset:0;z-index:8;pointer-events:none"><span data-source-label="q15-instruction" data-source-object="q15-instruction" style="position:absolute;left:124px;top:790px;width:690px;font-size:12.5px;line-height:1.4">請先分析左圖三條隨深度變化線各為何（P波、S波、密度），再依此畫出地函與核、外核與內核2條分界線，並延伸至右表；在右表填上該分層名稱、組成與狀態（固或液），及不連續面。 <b class="v4strict-num">(15)</b></span>${cells}</div>`;
   ...
   if(page===249){
     ...
     const q23=`<div class="v7-p249-q23 v5-recall" data-question="23" data-page="249" data-v7-source-figure-blanks="4" data-source-container-only="true" style="position:absolute;left:400px;top:650px;width:490px;height:245px;z-index:8;pointer-events:none"><span data-source-label="q23-instruction" data-source-object="q23-instruction" style="position:absolute;left:4px;top:-28px;width:300px;font-size:13px">請在【　】寫上地形名稱 <b class="v4strict-num">(23)</b></span><span style="position:absolute;left:24px;top:42px;pointer-events:auto">${f(23,0,78)}</span><span style="position:absolute;left:150px;top:18px;pointer-events:auto">${f(23,1,88)}</span><span style="position:absolute;left:278px;top:42px;pointer-events:auto">${f(23,2,78)}</span><span style="position:absolute;left:376px;top:23px;pointer-events:auto">${f(23,3,78)}</span></div>`;
